...
// You will have time to focus on it later.
                    ...
                    (function() {
                        ...
                        document.getElementById('run').addEventListener('click',function () {
                            ...
                            function search(firstname,lastname, myArray){
                                for (var i=0; i < myArray.length; i++) {
                                    if (myArray[i].firstname === firstname && myArray[i].lastname === lastname)
                                    {
                                        return myArray[i];
                                    }
                                }
                            ...
                            var resultObject = search("Jean","Dupont" , people);
                            console.log(resultObject);
                            var a = people.indexOf(resultObject);
                            console.log(a);
